...
var OP_post = function(s) {return new OP(false, s, true );};
var OP_pre  = function(s) {return new OP(true,  s, false);};
var OP_none = function(s) {return new OP(false, s, false);};
var OP_both = function(s) {return new OP(true,  s, true );};
...
module.exports = {OP, ISOP, lexify_punctuation, simplify_punctuation, serialize_sentence_part, normalize_punctuation};
