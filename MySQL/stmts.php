...
$sql_stmts['word_id,def_value,def_lang,form_tag,def_type->new in definitions']= "INSERT INTO definitions (word_id,def_value,def_lang,form_tag,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,word_id,def_lang,form_tag,def_type->new in definitions']= "INSERT INTO definitions (def_value,word_id,def_lang,form_tag,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_lang,def_value,form_tag,def_type->new in definitions']= "INSERT INTO definitions (word_id,def_lang,def_value,form_tag,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,word_id,def_value,form_tag,def_type->new in definitions']= "INSERT INTO definitions (def_lang,word_id,def_value,form_tag,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_lang,word_id,form_tag,def_type->new in definitions']= "INSERT INTO definitions (def_value,def_lang,word_id,form_tag,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_value,word_id,form_tag,def_type->new in definitions']= "INSERT INTO definitions (def_lang,def_value,word_id,form_tag,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_value,form_tag,def_lang,def_type->new in definitions']= "INSERT INTO definitions (word_id,def_value,form_tag,def_lang,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,word_id,form_tag,def_lang,def_type->new in definitions']= "INSERT INTO definitions (def_value,word_id,form_tag,def_lang,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,form_tag,def_value,def_lang,def_type->new in definitions']= "INSERT INTO definitions (word_id,form_tag,def_value,def_lang,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,word_id,def_value,def_lang,def_type->new in definitions']= "INSERT INTO definitions (form_tag,word_id,def_value,def_lang,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,form_tag,word_id,def_lang,def_type->new in definitions']= "INSERT INTO definitions (def_value,form_tag,word_id,def_lang,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_value,word_id,def_lang,def_type->new in definitions']= "INSERT INTO definitions (form_tag,def_value,word_id,def_lang,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_lang,form_tag,def_value,def_type->new in definitions']= "INSERT INTO definitions (word_id,def_lang,form_tag,def_value,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,word_id,form_tag,def_value,def_type->new in definitions']= "INSERT INTO definitions (def_lang,word_id,form_tag,def_value,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,form_tag,def_lang,def_value,def_type->new in definitions']= "INSERT INTO definitions (word_id,form_tag,def_lang,def_value,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,word_id,def_lang,def_value,def_type->new in definitions']= "INSERT INTO definitions (form_tag,word_id,def_lang,def_value,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,form_tag,word_id,def_value,def_type->new in definitions']= "INSERT INTO definitions (def_lang,form_tag,word_id,def_value,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_lang,word_id,def_value,def_type->new in definitions']= "INSERT INTO definitions (form_tag,def_lang,word_id,def_value,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_lang,form_tag,word_id,def_type->new in definitions']= "INSERT INTO definitions (def_value,def_lang,form_tag,word_id,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_value,form_tag,word_id,def_type->new in definitions']= "INSERT INTO definitions (def_lang,def_value,form_tag,word_id,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,form_tag,def_lang,word_id,def_type->new in definitions']= "INSERT INTO definitions (def_value,form_tag,def_lang,word_id,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_value,def_lang,word_id,def_type->new in definitions']= "INSERT INTO definitions (form_tag,def_value,def_lang,word_id,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,form_tag,def_value,word_id,def_type->new in definitions']= "INSERT INTO definitions (def_lang,form_tag,def_value,word_id,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_lang,def_value,word_id,def_type->new in definitions']= "INSERT INTO definitions (form_tag,def_lang,def_value,word_id,def_type) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_value,def_lang,def_type,form_tag->new in definitions']= "INSERT INTO definitions (word_id,def_value,def_lang,def_type,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,word_id,def_lang,def_type,form_tag->new in definitions']= "INSERT INTO definitions (def_value,word_id,def_lang,def_type,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_lang,def_value,def_type,form_tag->new in definitions']= "INSERT INTO definitions (word_id,def_lang,def_value,def_type,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,word_id,def_value,def_type,form_tag->new in definitions']= "INSERT INTO definitions (def_lang,word_id,def_value,def_type,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_lang,word_id,def_type,form_tag->new in definitions']= "INSERT INTO definitions (def_value,def_lang,word_id,def_type,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_value,word_id,def_type,form_tag->new in definitions']= "INSERT INTO definitions (def_lang,def_value,word_id,def_type,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_value,def_type,def_lang,form_tag->new in definitions']= "INSERT INTO definitions (word_id,def_value,def_type,def_lang,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,word_id,def_type,def_lang,form_tag->new in definitions']= "INSERT INTO definitions (def_value,word_id,def_type,def_lang,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_type,def_value,def_lang,form_tag->new in definitions']= "INSERT INTO definitions (word_id,def_type,def_value,def_lang,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,word_id,def_value,def_lang,form_tag->new in definitions']= "INSERT INTO definitions (def_type,word_id,def_value,def_lang,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_type,word_id,def_lang,form_tag->new in definitions']= "INSERT INTO definitions (def_value,def_type,word_id,def_lang,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_value,word_id,def_lang,form_tag->new in definitions']= "INSERT INTO definitions (def_type,def_value,word_id,def_lang,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_lang,def_type,def_value,form_tag->new in definitions']= "INSERT INTO definitions (word_id,def_lang,def_type,def_value,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,word_id,def_type,def_value,form_tag->new in definitions']= "INSERT INTO definitions (def_lang,word_id,def_type,def_value,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_type,def_lang,def_value,form_tag->new in definitions']= "INSERT INTO definitions (word_id,def_type,def_lang,def_value,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,word_id,def_lang,def_value,form_tag->new in definitions']= "INSERT INTO definitions (def_type,word_id,def_lang,def_value,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_type,word_id,def_value,form_tag->new in definitions']= "INSERT INTO definitions (def_lang,def_type,word_id,def_value,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_lang,word_id,def_value,form_tag->new in definitions']= "INSERT INTO definitions (def_type,def_lang,word_id,def_value,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_lang,def_type,word_id,form_tag->new in definitions']= "INSERT INTO definitions (def_value,def_lang,def_type,word_id,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_value,def_type,word_id,form_tag->new in definitions']= "INSERT INTO definitions (def_lang,def_value,def_type,word_id,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_type,def_lang,word_id,form_tag->new in definitions']= "INSERT INTO definitions (def_value,def_type,def_lang,word_id,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_value,def_lang,word_id,form_tag->new in definitions']= "INSERT INTO definitions (def_type,def_value,def_lang,word_id,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_type,def_value,word_id,form_tag->new in definitions']= "INSERT INTO definitions (def_lang,def_type,def_value,word_id,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_lang,def_value,word_id,form_tag->new in definitions']= "INSERT INTO definitions (def_type,def_lang,def_value,word_id,form_tag) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_value,form_tag,def_type,def_lang->new in definitions']= "INSERT INTO definitions (word_id,def_value,form_tag,def_type,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,word_id,form_tag,def_type,def_lang->new in definitions']= "INSERT INTO definitions (def_value,word_id,form_tag,def_type,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,form_tag,def_value,def_type,def_lang->new in definitions']= "INSERT INTO definitions (word_id,form_tag,def_value,def_type,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,word_id,def_value,def_type,def_lang->new in definitions']= "INSERT INTO definitions (form_tag,word_id,def_value,def_type,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,form_tag,word_id,def_type,def_lang->new in definitions']= "INSERT INTO definitions (def_value,form_tag,word_id,def_type,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_value,word_id,def_type,def_lang->new in definitions']= "INSERT INTO definitions (form_tag,def_value,word_id,def_type,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_value,def_type,form_tag,def_lang->new in definitions']= "INSERT INTO definitions (word_id,def_value,def_type,form_tag,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,word_id,def_type,form_tag,def_lang->new in definitions']= "INSERT INTO definitions (def_value,word_id,def_type,form_tag,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_type,def_value,form_tag,def_lang->new in definitions']= "INSERT INTO definitions (word_id,def_type,def_value,form_tag,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,word_id,def_value,form_tag,def_lang->new in definitions']= "INSERT INTO definitions (def_type,word_id,def_value,form_tag,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_type,word_id,form_tag,def_lang->new in definitions']= "INSERT INTO definitions (def_value,def_type,word_id,form_tag,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_value,word_id,form_tag,def_lang->new in definitions']= "INSERT INTO definitions (def_type,def_value,word_id,form_tag,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,form_tag,def_type,def_value,def_lang->new in definitions']= "INSERT INTO definitions (word_id,form_tag,def_type,def_value,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,word_id,def_type,def_value,def_lang->new in definitions']= "INSERT INTO definitions (form_tag,word_id,def_type,def_value,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_type,form_tag,def_value,def_lang->new in definitions']= "INSERT INTO definitions (word_id,def_type,form_tag,def_value,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,word_id,form_tag,def_value,def_lang->new in definitions']= "INSERT INTO definitions (def_type,word_id,form_tag,def_value,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_type,word_id,def_value,def_lang->new in definitions']= "INSERT INTO definitions (form_tag,def_type,word_id,def_value,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,form_tag,word_id,def_value,def_lang->new in definitions']= "INSERT INTO definitions (def_type,form_tag,word_id,def_value,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,form_tag,def_type,word_id,def_lang->new in definitions']= "INSERT INTO definitions (def_value,form_tag,def_type,word_id,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_value,def_type,word_id,def_lang->new in definitions']= "INSERT INTO definitions (form_tag,def_value,def_type,word_id,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_type,form_tag,word_id,def_lang->new in definitions']= "INSERT INTO definitions (def_value,def_type,form_tag,word_id,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_value,form_tag,word_id,def_lang->new in definitions']= "INSERT INTO definitions (def_type,def_value,form_tag,word_id,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_type,def_value,word_id,def_lang->new in definitions']= "INSERT INTO definitions (form_tag,def_type,def_value,word_id,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,form_tag,def_value,word_id,def_lang->new in definitions']= "INSERT INTO definitions (def_type,form_tag,def_value,word_id,def_lang) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_lang,form_tag,def_type,def_value->new in definitions']= "INSERT INTO definitions (word_id,def_lang,form_tag,def_type,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,word_id,form_tag,def_type,def_value->new in definitions']= "INSERT INTO definitions (def_lang,word_id,form_tag,def_type,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,form_tag,def_lang,def_type,def_value->new in definitions']= "INSERT INTO definitions (word_id,form_tag,def_lang,def_type,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,word_id,def_lang,def_type,def_value->new in definitions']= "INSERT INTO definitions (form_tag,word_id,def_lang,def_type,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,form_tag,word_id,def_type,def_value->new in definitions']= "INSERT INTO definitions (def_lang,form_tag,word_id,def_type,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_lang,word_id,def_type,def_value->new in definitions']= "INSERT INTO definitions (form_tag,def_lang,word_id,def_type,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_lang,def_type,form_tag,def_value->new in definitions']= "INSERT INTO definitions (word_id,def_lang,def_type,form_tag,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,word_id,def_type,form_tag,def_value->new in definitions']= "INSERT INTO definitions (def_lang,word_id,def_type,form_tag,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_type,def_lang,form_tag,def_value->new in definitions']= "INSERT INTO definitions (word_id,def_type,def_lang,form_tag,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,word_id,def_lang,form_tag,def_value->new in definitions']= "INSERT INTO definitions (def_type,word_id,def_lang,form_tag,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_type,word_id,form_tag,def_value->new in definitions']= "INSERT INTO definitions (def_lang,def_type,word_id,form_tag,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_lang,word_id,form_tag,def_value->new in definitions']= "INSERT INTO definitions (def_type,def_lang,word_id,form_tag,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,form_tag,def_type,def_lang,def_value->new in definitions']= "INSERT INTO definitions (word_id,form_tag,def_type,def_lang,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,word_id,def_type,def_lang,def_value->new in definitions']= "INSERT INTO definitions (form_tag,word_id,def_type,def_lang,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['word_id,def_type,form_tag,def_lang,def_value->new in definitions']= "INSERT INTO definitions (word_id,def_type,form_tag,def_lang,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,word_id,form_tag,def_lang,def_value->new in definitions']= "INSERT INTO definitions (def_type,word_id,form_tag,def_lang,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_type,word_id,def_lang,def_value->new in definitions']= "INSERT INTO definitions (form_tag,def_type,word_id,def_lang,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,form_tag,word_id,def_lang,def_value->new in definitions']= "INSERT INTO definitions (def_type,form_tag,word_id,def_lang,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,form_tag,def_type,word_id,def_value->new in definitions']= "INSERT INTO definitions (def_lang,form_tag,def_type,word_id,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_lang,def_type,word_id,def_value->new in definitions']= "INSERT INTO definitions (form_tag,def_lang,def_type,word_id,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_type,form_tag,word_id,def_value->new in definitions']= "INSERT INTO definitions (def_lang,def_type,form_tag,word_id,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_lang,form_tag,word_id,def_value->new in definitions']= "INSERT INTO definitions (def_type,def_lang,form_tag,word_id,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_type,def_lang,word_id,def_value->new in definitions']= "INSERT INTO definitions (form_tag,def_type,def_lang,word_id,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,form_tag,def_lang,word_id,def_value->new in definitions']= "INSERT INTO definitions (def_type,form_tag,def_lang,word_id,def_value) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_lang,form_tag,def_type,word_id->new in definitions']= "INSERT INTO definitions (def_value,def_lang,form_tag,def_type,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_value,form_tag,def_type,word_id->new in definitions']= "INSERT INTO definitions (def_lang,def_value,form_tag,def_type,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,form_tag,def_lang,def_type,word_id->new in definitions']= "INSERT INTO definitions (def_value,form_tag,def_lang,def_type,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_value,def_lang,def_type,word_id->new in definitions']= "INSERT INTO definitions (form_tag,def_value,def_lang,def_type,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,form_tag,def_value,def_type,word_id->new in definitions']= "INSERT INTO definitions (def_lang,form_tag,def_value,def_type,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_lang,def_value,def_type,word_id->new in definitions']= "INSERT INTO definitions (form_tag,def_lang,def_value,def_type,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_lang,def_type,form_tag,word_id->new in definitions']= "INSERT INTO definitions (def_value,def_lang,def_type,form_tag,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_value,def_type,form_tag,word_id->new in definitions']= "INSERT INTO definitions (def_lang,def_value,def_type,form_tag,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_type,def_lang,form_tag,word_id->new in definitions']= "INSERT INTO definitions (def_value,def_type,def_lang,form_tag,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_value,def_lang,form_tag,word_id->new in definitions']= "INSERT INTO definitions (def_type,def_value,def_lang,form_tag,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_type,def_value,form_tag,word_id->new in definitions']= "INSERT INTO definitions (def_lang,def_type,def_value,form_tag,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_lang,def_value,form_tag,word_id->new in definitions']= "INSERT INTO definitions (def_type,def_lang,def_value,form_tag,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,form_tag,def_type,def_lang,word_id->new in definitions']= "INSERT INTO definitions (def_value,form_tag,def_type,def_lang,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_value,def_type,def_lang,word_id->new in definitions']= "INSERT INTO definitions (form_tag,def_value,def_type,def_lang,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_value,def_type,form_tag,def_lang,word_id->new in definitions']= "INSERT INTO definitions (def_value,def_type,form_tag,def_lang,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_value,form_tag,def_lang,word_id->new in definitions']= "INSERT INTO definitions (def_type,def_value,form_tag,def_lang,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_type,def_value,def_lang,word_id->new in definitions']= "INSERT INTO definitions (form_tag,def_type,def_value,def_lang,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,form_tag,def_value,def_lang,word_id->new in definitions']= "INSERT INTO definitions (def_type,form_tag,def_value,def_lang,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,form_tag,def_type,def_value,word_id->new in definitions']= "INSERT INTO definitions (def_lang,form_tag,def_type,def_value,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_lang,def_type,def_value,word_id->new in definitions']= "INSERT INTO definitions (form_tag,def_lang,def_type,def_value,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_lang,def_type,form_tag,def_value,word_id->new in definitions']= "INSERT INTO definitions (def_lang,def_type,form_tag,def_value,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,def_lang,form_tag,def_value,word_id->new in definitions']= "INSERT INTO definitions (def_type,def_lang,form_tag,def_value,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['form_tag,def_type,def_lang,def_value,word_id->new in definitions']= "INSERT INTO definitions (form_tag,def_type,def_lang,def_value,word_id) VALUES (?, ?, ?, ?, ?)";
$sql_stmts['def_type,form_tag,def_lang,def_value,word_id->new in definitions']= "INSERT INTO definitions (def_type,form_tag,def_lang,def_value,word_id) VALUES (?, ?, ?, ?, ?)";
...
$sql_stmts['quiz_id->mode']= "SELECT mode FROM quizzes WHERE quiz_id = (?)";
...
$sql_stmts['user_id,type,last,mode->new in quizzes']= "INSERT INTO quizzes (user_id,type,last,mode) VALUES (?, ?, ?, ?)";
$sql_stmts['type,user_id,last,mode->new in quizzes']= "INSERT INTO quizzes (type,user_id,last,mode) VALUES (?, ?, ?, ?)";
$sql_stmts['user_id,last,type,mode->new in quizzes']= "INSERT INTO quizzes (user_id,last,type,mode) VALUES (?, ?, ?, ?)";
$sql_stmts['last,user_id,type,mode->new in quizzes']= "INSERT INTO quizzes (last,user_id,type,mode) VALUES (?, ?, ?, ?)";
$sql_stmts['type,last,user_id,mode->new in quizzes']= "INSERT INTO quizzes (type,last,user_id,mode) VALUES (?, ?, ?, ?)";
$sql_stmts['last,type,user_id,mode->new in quizzes']= "INSERT INTO quizzes (last,type,user_id,mode) VALUES (?, ?, ?, ?)";
$sql_stmts['user_id,type,mode,last->new in quizzes']= "INSERT INTO quizzes (user_id,type,mode,last) VALUES (?, ?, ?, ?)";
$sql_stmts['type,user_id,mode,last->new in quizzes']= "INSERT INTO quizzes (type,user_id,mode,last) VALUES (?, ?, ?, ?)";
$sql_stmts['user_id,mode,type,last->new in quizzes']= "INSERT INTO quizzes (user_id,mode,type,last) VALUES (?, ?, ?, ?)";
$sql_stmts['mode,user_id,type,last->new in quizzes']= "INSERT INTO quizzes (mode,user_id,type,last) VALUES (?, ?, ?, ?)";
$sql_stmts['type,mode,user_id,last->new in quizzes']= "INSERT INTO quizzes (type,mode,user_id,last) VALUES (?, ?, ?, ?)";
$sql_stmts['mode,type,user_id,last->new in quizzes']= "INSERT INTO quizzes (mode,type,user_id,last) VALUES (?, ?, ?, ?)";
$sql_stmts['user_id,last,mode,type->new in quizzes']= "INSERT INTO quizzes (user_id,last,mode,type) VALUES (?, ?, ?, ?)";
$sql_stmts['last,user_id,mode,type->new in quizzes']= "INSERT INTO quizzes (last,user_id,mode,type) VALUES (?, ?, ?, ?)";
$sql_stmts['user_id,mode,last,type->new in quizzes']= "INSERT INTO quizzes (user_id,mode,last,type) VALUES (?, ?, ?, ?)";
$sql_stmts['mode,user_id,last,type->new in quizzes']= "INSERT INTO quizzes (mode,user_id,last,type) VALUES (?, ?, ?, ?)";
$sql_stmts['last,mode,user_id,type->new in quizzes']= "INSERT INTO quizzes (last,mode,user_id,type) VALUES (?, ?, ?, ?)";
$sql_stmts['mode,last,user_id,type->new in quizzes']= "INSERT INTO quizzes (mode,last,user_id,type) VALUES (?, ?, ?, ?)";
$sql_stmts['type,last,mode,user_id->new in quizzes']= "INSERT INTO quizzes (type,last,mode,user_id) VALUES (?, ?, ?, ?)";
$sql_stmts['last,type,mode,user_id->new in quizzes']= "INSERT INTO quizzes (last,type,mode,user_id) VALUES (?, ?, ?, ?)";
$sql_stmts['type,mode,last,user_id->new in quizzes']= "INSERT INTO quizzes (type,mode,last,user_id) VALUES (?, ?, ?, ?)";
